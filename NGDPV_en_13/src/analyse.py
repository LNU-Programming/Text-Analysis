...
def initialize_statistics(filename: str) -> dict[str, any]:
    """
    Initialize the statistics dictionary. This dictionary contains
    all the statistics generated by our code, and is passed around
    between each module, to facilitate the viewing our the data.
...
def initialize_analysis_data() -> dict[str, any]:
    """
    Initialize temporary data structures used only during text analysis.
